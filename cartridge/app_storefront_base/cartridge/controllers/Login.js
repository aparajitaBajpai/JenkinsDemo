...
server.get('OAuthLogin', server.middleware.https, consentTracking.consent, function (req, res, next) {
    ...
    dw.system.Logger.error("oath login working");
    ...
    if (req.querystring.oauthProvider) {
        ...
        dw.system.Logger.error("under provider-->"+oauthProvider);
        var result = oauthLoginFlowMgr.initiateOAuthLogin("google.com");
        
    dw.system.Logger.error("result-->"+result);
    if(result == null){
